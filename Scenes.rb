...
class Practice < Scene
    enter4()
        ...
        if decision == "continue"
            ...
            puts "When you finish your coach looks irate. Do you apologize?"
            puts "> "
            get.chomp
            return "home"
        end
...
class Hike < Scene
    enter6()
        ...
        if calories == 349 || calories == 420 
            ...
            return "home"
        elsif calories == 273 || calories == 231 || calories == 297 || calories == 247
